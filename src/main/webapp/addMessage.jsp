...
<html>
    ...
    <h2>Пользователь <c:if test="${username!=null}"> <font color="#4b0082">${username}</font>  <a href="logout.jsp">(выйти)</a></c:if>  <c:if test="${username==null}"> <font color="#4b0082">Аноним</font> <a href="index.jsp">(войти)</a> </c:if> !!!!!</h2>
